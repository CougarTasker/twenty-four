...
class Background:
    def __init__(self,dimensions):
        ...
        self.bubbles = SpriteSheet("https://raw.githubusercontent.com/CougarTasker/twenty-four/master/proto/images/bubble2.png",(15,5),time=1250,scale=0.04,pos=Vector(100,200))
